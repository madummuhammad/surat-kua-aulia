...
<main>
	...
	<div class="container-fluid px-4">
		...
		@endif
		<form action="{{ route('permohonan.update',$item->id) }}" method="post" enctype="multipart/form-data">
			@method('PATCH')
			@csrf
			<div class="row gx-4">
				<div class="col-lg-9">
					<div class="card mb-4">
						...
						<div class="card-body">
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control @error('id_user') is-invalid @enderror" value="{{$item->nik_user}}" name="id_user" placeholder="ID Masyarakat.." required readonly>
								</div>
								@error('id_user')
