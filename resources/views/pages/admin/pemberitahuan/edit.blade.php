...
@section('title')
Ubah Surat Pemberitahuan Kekurangan Syarat Perkawinan
@endsection
...
<main>
				...
				<div class="row align-items-center justify-content-between pt-3">
					...
					<div class="col-12 col-xl-auto mb-3">
						<button class="btn btn-sm btn-light text-primary" onclick="javascript:window.history.back();">
							...
							Kembali Ke Semua Surat Pemberitahuan Kekurangan Syarat Perkawinan
						</button>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid px-4">
		...
		@endif
		<form action="{{ route('pemberitahuan.update', $item->id) }}" method="post" enctype="multipart/form-data">
			@csrf
			@method('PUT')
			<div class="row gx-4">
				<div class="col-lg-9">
					<div class="card mb-4">
						...
						<div class="card-body">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<textarea name="isi_surat" class="form-control @error('isi_surat') is-invalid @enderror" cols="30" rows="10" required>{{$item->isi_surat}}</textarea>
								</div>
								@error('isi_surat')
								<div class="invalid-feedback">
									{{ $message; }}
