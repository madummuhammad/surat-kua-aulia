					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control @error('no_disposisi') is-invalid @enderror" value="{{ $item->no_disposisi }}" name="no_disposisi" placeholder="Nomor Disposisi.." required>
								</div>
								@error('no_disposisi')
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<input type="file" class="form-control @error('file_disposisi') is-invalid @enderror" value="{{ old('file_disposisi') }}" accept=".pdf" name="file_disposisi">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<textarea name="isi_disposisi" class="form-control @error('isi_disposisi') is-invalid @enderror" cols="30" rows="10" required>{{$item->isi_disposisi}}</textarea>
								</div>
								@error('isi_disposisi')
								<div class="invalid-feedback">
									{{ $message; }}
