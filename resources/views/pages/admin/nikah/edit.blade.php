...
@section('title')
Ubah Surat Permintaan Buku Nikah dan Akta Nikah
@endsection
...
<main>
				...
				<div class="row align-items-center justify-content-between pt-3">
					...
					<div class="col-12 col-xl-auto mb-3">
						<button class="btn btn-sm btn-light text-primary" onclick="javascript:window.history.back();">
							...
							Kembali Ke Semua Surat Permintaan Buku Nikah dan Akta Nikah
						</button>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid px-4">
		...
		@endif
		<form action="{{ route('nikah.update', $item->id) }}" method="post" enctype="multipart/form-data">
			@csrf
			@method('PUT')
			<div class="row gx-4">
				<div class="col-lg-9">
